...
class Sarcomere_Simulation:
	def __init__(self):
		...
		thick= float(input("Thick filament/Myosin: "))
		thin = float(input("Thin Filament/Actin: "))
		bare = float(input("Bare Zone= "))
		zdisc = float(input("Z Disc = "))
		T0 = float(input("Median Max Tension = "))
		radius = float(input("Radius = "))
		LM = float(input("Muscle Length = "))
